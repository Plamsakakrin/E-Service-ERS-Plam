...
<div class="container">
    ...
    <div class="row">
        <!-- <div class="col-12">
                <div class="card">
                    <div class="card-body">
                    <a href="{{route('searchbig_org')}}" class="btn btn-link">องค์การใหญ่</a>
                    <a href="#" class="btn btn-link">องค์การย่อย</a>
                    </div>
                </div>
            </div> -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="cardd card-1" style="height:120px; text-align:center; border: none;">
                ...
                <div class="col-md-6">
                    ...
                    <div class="cardd card-3" style="height:120px; text-align:center; border: none;">
                            <br>
